...
export const metadata = { title: 'Accepted Items • Integritrade LLC' }
    ...
    <section className="section py-16  bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 flex items-center justify-center gap-4">
          <a
            href="#schedule"
            className="rounded-md bg-blue-500 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:opacity-95"
          >
            Schedule Drop-off
          </a>
          <a
        ...
        <div className="section mt-20 ">
          <div className="rounded-md border-2 border-dashed px-6 py-10 text-center bg-white">
            <Mail className="mx-auto h-7 w-7 text-blue-500" />
            ...
            <div className="mt-5 flex items-center justify-center gap-3">
              <a
                href="#contact"
                className="rounded-md bg-blue-500 px-4 py-2 text-sm font-semibold text-white hover:opacity-95"
              >
